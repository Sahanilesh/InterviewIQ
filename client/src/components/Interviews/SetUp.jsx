...
function SetUp({ onStart }) {
    ...
    const handelStart = async () =>{
        setLoading(true)
        try {
            const result = await axios.post(Server_URL + "/api/interview/generate-question", 
    ...
    return (
        <motion.div
            ...
            className='min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to bg-gray-200 px-4'>
            <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
                <motion.div
                    initial={{ x: -80, opacity: 0 }}
                    animate={{ x: 0, opacity: 1 }}
                    transition={{ duration: 0.7 }}
                    className='relative bg-gradient-to-br from-green-50 to bg-green-100 p-12 flex flex-col justify-center'>
                    <h2 className='text-4xl font-bold text-gray-800 mb-6'>
                        Start Your AI Interview
                    </h2>
                    <p className='text-gray-600 mb-10'>
                        Practice real interview senarios powred by AI.
                ...
                <motion.div
                    ...
                    <div className='space-y-6'>
                        ...
                        <div className='relative'>
                            <SlOptionsVertical className='absolute top-4 left-4 text-gray-400' />
                            <select value={mode}

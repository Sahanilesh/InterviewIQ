        ...
        <div className='bg-[#f3f3f3] flex justify-center px-4 pb-10 py-4 pt-10'>
            <div className='w-full max-w-6xl bg-white rounded-[24px] shadow-sm border border-gray-200 py-8 px-3 text-center'>
                ...
                <p className='text-gray-500 text-sm max-w-xl mx-auto'>
                    InterviewIQ.AI is an AI-powered interview preparation platform that helps job seekers practice and improve their interview skills through realistic mock interviews, personalized feedback, and a wide range of interview questions across various industries.
                </p>
            </div>
        </div>
    )

        ...
        ${isModel ? "py-4": "min-h-screen bg-[#f3f3f3] flex items-center justify-center px-6 py-20"}`}>
            ...
            `}>
                ...
                <p className='text-gray-500 text-center text-sm md:text-base leading-relaxed mb-8'>
                    Sign in to your account to continue and access all the features of InterviewIQ.AI. 
                    We use AI technology to help you prepare for your interviews and improve your chances of success.
                </p>
                {error && (

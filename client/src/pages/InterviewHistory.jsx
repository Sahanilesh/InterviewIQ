...
function InterviewHistory() {
    ...
    return (
        <div className='min-h-screen bg-linear-to-r from-gray-50 to-emerald-50 py-10'>
            <div className='w-[90vw] lg:w-[70vm] max-w-[90%] mx-auto'>
                ...
                {interviews.length === 0 ?
                    ...
                    <div className='grid gap-6'>
                        {interviews.map((item, index) => (
                            ...
                            className='bg-white p-6 rounded-2xl shadow-mb hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100'>
